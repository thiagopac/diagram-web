...
class PracticeLine {
	...
	public function getPracticeLinesForLine($paramLine){
		...
		$SQL = "SELECT OSPL.ID AS OPENING_PRACTICE_LINE_ID, OSPL.PGN AS OPENING_PRACTICE_LINE_PGN, OSPL.DIN AS OPENING_PRACTICE_LINE_DATE_CREATED, OSTL.ID AS OPENING_LINE_ID, OSTL.NAME AS OPENING_LINE_NAME, OSTL.TEXT AS OPENING_LINE_TEXT, OSTL.PGN AS OPENING_LINE_PGN, OSTL.DIN AS OPENING_LINE_DATE_CREATED
