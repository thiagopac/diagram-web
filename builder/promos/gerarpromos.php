				...
				<div class="tab-pane" id="tab_7">
					<div class="portlet box blue ">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Dados mestre do promo
							</div>
							<div class="tools">
                                                            ...
                                                            <form action="../exec/" class="form-horizontal form-bordered form-label-stripped" method="POST">
                                                                    ...
                                                                    <div class="form-body">
                                                                            <div class="form-group">
                                                                                    ...
                                                                                    <div class="col-md-4">
																						<select class="form-control input-xlarge select2me" data-placeholder="[ID] - Nome do local" id="LocalPromo" name="LocalPromo">
																							<option value=""></option>
																								<?
																						...
																						<span class="help-block">Este é o local para o qual será criado os checkins</span>
																					</div>
                                                                            </div>
                                                                            ...
                                                                            <div class="form-group">
                                                                                    <label class="control-label col-md-3">Nome</label>
                                                                                     ...
                                                                                     <div class="col-md-5">
																						<input type="text" class="form-control" placeholder="Nome do promo" name="NomePromo" id="NomePromo">
                                                                             ...
                                                                             <div class="form-group">
                                                                                    <label class="control-label col-md-3">Período de validade</label>
                                                                                     ...
                                                                                     <div class="col-md-5">
																						...
																						<span class="help-block"> Tempo total de validade da promoção.</span>
																					</div>
                                                                             ...
                                                                             <div class="form-group">
                                                                                    <label class="control-label col-md-3">Lote</label>
                                                                                     ...
                                                                                     <div class="col-md-5">
																						<input type="text" class="form-control" placeholder="Quantidade de códigos" name="quantidadeCodigos" id="quantidadeCodigos">
																						<span class="help-block"> A quantidade mínima é 1 código e a máxima é 3.200.000 ;)</span>
																					</div>
                                                                             ...
                                                                             <div class="form-group">
                                                                                    <label class="control-label col-md-3">É promo de checkin?</label>
                                                                                     ...
                                                                                     <div class="col-md-9">
																						...
																						<span class="help-block"> Marque aqui caso seja um promo que deve ser enviado automaticamente após checkin do usuário no local</span>
																					</div>
