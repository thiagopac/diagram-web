		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					Visão dos Alunos Confirmados <small></small>
					</h3>
					...
					<div class="portlet box red">
						...
						<div class="portlet-body flip-scroll">
							...
							<tr>
								...
								<th class="numeric">
									 Alunos sem confirmar
								</th>
								<th class="numeric">
									 Alunos que confirmaram via SMS
								</th>
								<th class="numeric">
									 Alunos que confirmaram via APP
								</th>
								<th class="numeric">
									 Alunos que confirmaram via WEB
								</th>
								<th class="numeric">
							...
							foreach($RET as $KEY => $ROW)
								...
								<tr>
									...
									<td>
										 <?=fnFormataNumero($ROW['TOTAL'],$ROW['TOTAL'],'', $CHECK_PERCENT)?>
									</td>
									<td>
										 <?=fnFormataNumero($ROW['TOTAL'],$ROW['TOTAL_ALUNOS_SEM_CONFIRMAR'],'', $CHECK_PERCENT)?>
									</td>
									<td>
										 <?=fnFormataNumero($ROW['TOTAL'],$ROW['TOTAL_SMS'],'', $CHECK_PERCENT)?>
									</td>
									<td>
										 <?=fnFormataNumero($ROW['TOTAL'],$ROW['TOTAL_APP'],'', $CHECK_PERCENT)?>
									</td>
									<td>
										 <?=fnFormataNumero($ROW['TOTAL'],$ROW['TOTAL_WEB'],'', $CHECK_PERCENT)?>
									</td>
									<td>
										 <?=fnFormataNumero($ROW['TOTAL'],$ROW['TOTAL_ALUNOS'],'', $CHECK_PERCENT)?>
									</td>
								</tr>
								<?
								}
								...
								<tr>
									...
									<td>
										 <?=fnFormataNumero($ROW['TOTAL'],$ROW['TOTAL_ALUNOS_SEM_CONFIRMAR'],'b', $CHECK_PERCENT)?>
									</td>
									<td>
										 <?=fnFormataNumero($ROW['TOTAL'],$ROW['TOTAL_SMS'],'b', $CHECK_PERCENT)?>
									</td>
									<td>
										 <?=fnFormataNumero($ROW['TOTAL'],$ROW['TOTAL_APP'],'b', $CHECK_PERCENT)?>
									</td>
									<td>
										 <?=fnFormataNumero($ROW['TOTAL'],$ROW['TOTAL_WEB'],'b', $CHECK_PERCENT)?>
									</td>
									<td>
										 <?=fnFormataNumero($ROW['TOTAL'],$ROW['TOTAL_ALUNOS'],'b', $CHECK_PERCENT)?>
									</td>
								</tr>
							</tbody>
							</table>
